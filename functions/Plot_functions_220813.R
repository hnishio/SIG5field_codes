...
diff_vis_SunShade <- function(df, var, season){
  ...
  g1 <- ggplot(data = df, aes(x = time)) +
    ...
    labs(title = paste0(var, " (", subtitle, ")"),
         y = "Relative\ntranscript\nabundance")
...
diff_vis_local <- function(df, var){
  ...
  if(var=="AhgCCA1"){
    ...
    ymin2 <- -4; ymax2 <- 10; seq2 <- seq(-12,8,4)
  }else if(var=="AhgSIG5"){
    ymin1 <- -0.5; ymax1 <- 5; seq1 <- seq(0,5,1)
    ymin2 <- -1.5; ymax2 <- 2; seq2 <- seq(-2,2,1)
  }else if(var=="AhgpsbD BLRP"){
...
Pred_vis <- function(df1, df2, var){
  ...
  if(var=="AhgCCA1"){
    ...
    ymin4 <- -0.08; ymax4 <- 0.04; seq4 <- seq(-0.08,0.04,0.04) 
    ymin6 <- -5; ymax6 <- 27; seq6 <- seq(0,25,5) 
    tag_local <- "E"
  }else if(var=="AhgSIG5"){
    ymin1 <- -0.5; ymax1 <- 3.1; seq1 <- seq(0,3,1)
    ymin3 <- -0.1; ymax3 <- 0.05; seq3 <- seq(-0.1,0.05,0.05)
    ymin4 <- -0.003; ymax4 <- 0.006; seq4 <- seq(-0.003,0.006,0.003) 
    ymin5 <- -0.2; ymax5 <- 1.5; seq5 <- seq(-0,1.5,0.5)
    ymin6 <- -0.7; ymax6 <- 4; seq6 <- seq(0,4,1)
    tag_local <- "F"
  }else if(var=="AhgpsbD BLRP"){
    ymin1 <- 0; ymax1 <- 4.5; seq1 <- seq(0,4,2)
    ymin3 <- -0.02; ymax3 <- 0.12; seq3 <- seq(0,0.12,0.04)
    ymin4 <- -0.005; ymax4 <- 0.005; seq4 <- seq(-0.005,0.005,0.005) 
...
##### Visualization of SSM prediction 2 #####

Pred_vis2 <- function(df1, df2, var){
  ...
  if(var=="AhgCCA1"){
    ...
    ymin1 <- -0.5; ymax1 <- 3.1; seq1 <- seq(0,3,1)
    ymin3 <- -0.16; ymax3 <- 0.05; seq3 <- c(-0.15,-0.1,-0.05,0,0.05)
    ymin4 <- -0.01; ymax4 <- 0.01; seq4 <- seq(-0.01,0.01,0.005) 
    ymin5 <- -0.2; ymax5 <- 1; seq5 <- seq(0,1,0.5)
    ymin6 <- -0.7; ymax6 <- 4; seq6 <- seq(0,4,1)
    tag_local <- "F"
  }else if(var=="AhgpsbD BLRP"){
    ymin1 <- 0; ymax1 <- 4.5; seq1 <- seq(0,4,2)
    ymin3 <- -0.02; ymax3 <- 0.08; seq3 <- seq(0,0.08,0.04)
    ymin4 <- -0.01; ymax4 <- 0.01; seq4 <- seq(-0.01,0.01,0.005) 
    ymin5 <- -0.6; ymax5 <- 2.2; seq5 <- seq(-0.5,2,0.5)
    ymin6 <- 0; ymax6 <- 4.2; seq6 <- seq(0,4,2)
    tag_local <- "F"
  }
...
Pred_vis_local <- function(df, var){
  
  if(var=="AhgCCA1"){
    ymin1 <- -3; ymax1 <- 27; seq1 <- seq(0,25,5)
    ymin2 <- -0.6; ymax2 <- 0.5; seq2 <- seq(-0.5,1,0.5)
    ymin3 <- -0.04; ymax3 <- 0.04; seq3 <- seq(-0.04,0.04,0.04) 
  }else if(var=="AhgSIG5"){
    ymin1 <- -0.3; ymax1 <- 4; seq1 <- seq(0,4,1)
    ymin2 <- -0.07; ymax2 <- 0.07; seq2 <- seq(-0.07,0.07,0.07)
    ymin3 <- -0.003; ymax3 <- 0.005; seq3 <- seq(-0.003,0.003,0.003) 
    ymin4 <- -0.5; ymax4 <- 1; seq4 <- seq(-0.5,1,0.5)
  }else if(var=="AhgpsbD BLRP"){
    ymin1 <- -0.3; ymax1 <- 8; seq1 <- seq(0,8,4)
    ymin2 <- -0.1; ymax2 <- 0.4; seq2 <- seq(0,0.4,0.2)
    ymin3 <- -0.02; ymax3 <- 0.02; seq3 <- seq(-0.02,0.02,0.01) 
    ymin4 <- -0.7; ymax4 <- 2.6; seq4 <- seq(0,2,1)
  }
  
  g1 <- ggplot(data = df, aes(x = time)) +
    annotate("rect", xmin = 12, xmax = 24, ymin = ymin1, ymax = ymax1, alpha = 0.3, fill = "gray50") +
    annotate("rect", xmin = 36, xmax = 39, ymin = ymin1, ymax = ymax1, alpha = 0.3, fill = "gray50") +
    geom_ribbon(aes(ymin = alpha_ambient_2.5, ymax = alpha_ambient_97.5), alpha = 0.3, fill = "black") +
    geom_line(aes(y = alpha_ambient_50), col = "black") +
    geom_point(aes(y = data_ambient), col = "black", alpha = 0.6) +
    geom_ribbon(aes(ymin = alpha_warm_2.5, ymax = alpha_warm_97.5), alpha = 0.3, fill = "orangered") +
    geom_line(aes(y = alpha_warm_50), col = "orangered") +
    geom_point(aes(y = data_warm), col = "orangered", alpha = 0.6) +
    geom_ribbon(aes(ymin = alpha_chill_2.5, ymax = alpha_chill_97.5), alpha = 0.3, fill = "cyan3") +
    geom_line(aes(y = alpha_chill_50), col = "cyan3") +
    geom_point(aes(y = data_chill), col = "cyan3", alpha = 0.6) +
    scale_x_continuous(breaks=seq(12,36,6)) +
    scale_y_continuous(expand = c(0,0), breaks=seq1) +
    coord_cartesian(clip = 'off') +
    theme_classic(base_size = 7) +
  ...
  g3 <- ggplot(data = df, aes(x = time)) +
    annotate("rect", xmin = 12, xmax = 24, ymin = ymin3, ymax = ymax3, alpha = 0.3, fill = "gray50")+
    annotate("rect", xmin = 36, xmax = 39, ymin = ymin3, ymax = ymax3, alpha = 0.3, fill = "gray50") +
    geom_ribbon(aes(ymin = b_light_2.5, ymax = b_light_97.5), alpha = 0.5) +
    geom_line(aes(y = b_light_50)) +
    geom_hline(yintercept = 0, linetype="dashed") +
    scale_x_continuous(breaks=seq(12,36,6)) + 
  ...
  if(var=="AhgSIG5"){
    g4 <- ggplot(data = df, aes(x = time)) +
      annotate("rect", xmin = 12, xmax = 24, ymin = ymin4, ymax = ymax4, alpha = 0.3, fill = "gray50") +
      annotate("rect", xmin = 36, xmax = 39, ymin = ymin4, ymax = ymax4, alpha = 0.3, fill = "gray50") +
      geom_ribbon(aes(ymin = b_CCA1_2.5, ymax = b_CCA1_97.5), alpha = 0.5) +
      geom_line(aes(y = b_CCA1_50)) +
      geom_hline(yintercept = 0, linetype="dashed") +
      scale_x_continuous(breaks=seq(12,36,6)) + 
